...
const ROWS = [
  [
    { title: "Programming Languages", items: ["Java", "C", "C++", "Python"] },
    { title: "Frontend Technologies", items: ["HTML", "CSS", "JavaScript", "React"] },
    { title: "Backend Technologies", items: ["Node.js", "Express.js"] },
    ...
    <section className="skills-container" id="skills">
      ...
      >
        ...
        <p className="text-gray-400 text-lg max-w-xl mx-auto">
          ✨Crafting scalable web solutions with modern technologies — explore my technical skills below.
        </p>
      </motion.div>
